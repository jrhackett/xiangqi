...
private XiangqiGame game;
	...
	@Test
	public void getPieceAtCanReturnCannonsAtTheStartOfGameWithRespectiveAspects() {
		final XiangqiPiece red1 = game.getPieceAt(TestCoordinate.makeCoordinate(3, 2), XiangqiColor.RED);
		final XiangqiPiece red2 = game.getPieceAt(TestCoordinate.makeCoordinate(3, 8), XiangqiColor.RED);
		final XiangqiPiece black1 = game.getPieceAt(TestCoordinate.makeCoordinate(3, 2), XiangqiColor.BLACK);
		final XiangqiPiece black2 = game.getPieceAt(TestCoordinate.makeCoordinate(3, 8), XiangqiColor.BLACK);
		
		assertEquals(XiangqiColor.RED, red1.getColor());
		assertEquals(XiangqiPieceType.CANNON, red1.getPieceType());
		assertEquals(XiangqiColor.RED, red2.getColor());
		assertEquals(XiangqiPieceType.CANNON, red2.getPieceType());
		
		assertEquals(XiangqiColor.BLACK, black1.getColor());
		assertEquals(XiangqiPieceType.CANNON, black1.getPieceType());
		assertEquals(XiangqiColor.BLACK, black2.getColor());
		assertEquals(XiangqiPieceType.CANNON, black2.getPieceType());
	}
	
	@Test
	public void getPieceAtCanReturnCannonsAtTheStartOfGameWithOppositeAspects() {
		final XiangqiPiece red1 = game.getPieceAt(TestCoordinate.makeCoordinate(8, 2), XiangqiColor.BLACK);
		final XiangqiPiece red2 = game.getPieceAt(TestCoordinate.makeCoordinate(8, 8), XiangqiColor.BLACK);
		final XiangqiPiece black1 = game.getPieceAt(TestCoordinate.makeCoordinate(8, 2), XiangqiColor.RED);
		final XiangqiPiece black2 = game.getPieceAt(TestCoordinate.makeCoordinate(8, 8), XiangqiColor.RED);
	...
	@Test
	public void getPieceAtCanReturnHorsesAtTheStartOfGameWithRespectiveAspects() {
		final XiangqiPiece red1 = game.getPieceAt(TestCoordinate.makeCoordinate(1, 2), XiangqiColor.RED);
		final XiangqiPiece red2 = game.getPieceAt(TestCoordinate.makeCoordinate(1, 8), XiangqiColor.RED);
		final XiangqiPiece black1 = game.getPieceAt(TestCoordinate.makeCoordinate(1, 2), XiangqiColor.BLACK);
		final XiangqiPiece black2 = game.getPieceAt(TestCoordinate.makeCoordinate(1, 8), XiangqiColor.BLACK);
		
		assertEquals(XiangqiColor.RED, red1.getColor());
		assertEquals(XiangqiPieceType.HORSE, red1.getPieceType());
		assertEquals(XiangqiColor.RED, red2.getColor());
		assertEquals(XiangqiPieceType.HORSE, red2.getPieceType());
		
		assertEquals(XiangqiColor.BLACK, black1.getColor());
		assertEquals(XiangqiPieceType.HORSE, black1.getPieceType());
		assertEquals(XiangqiColor.BLACK, black2.getColor());
		assertEquals(XiangqiPieceType.HORSE, black2.getPieceType());
	}
	
	@Test
	public void getPieceAtCanReturnHorsesAtTheStartOfGameWithOppositeAspects() {
		final XiangqiPiece red1 = game.getPieceAt(TestCoordinate.makeCoordinate(10, 2), XiangqiColor.BLACK);
		final XiangqiPiece red2 = game.getPieceAt(TestCoordinate.makeCoordinate(10, 8), XiangqiColor.BLACK);
		final XiangqiPiece black1 = game.getPieceAt(TestCoordinate.makeCoordinate(10, 2), XiangqiColor.RED);
		final XiangqiPiece black2 = game.getPieceAt(TestCoordinate.makeCoordinate(10, 8), XiangqiColor.RED);
